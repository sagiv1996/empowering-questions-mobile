...
class _RestQuestion implements RestQuestion {
  _RestQuestion(
    this._dio, {
    this.baseUrl,
  }) {
  ...
  @override
  Future<List<Question>>? fetchRandom(List<String>? excludeIds) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'excludeIds': excludeIds};
  ...
  @override
  Future<Question> fetchById(String id) async {
    final _extra = <String, dynamic>{};
